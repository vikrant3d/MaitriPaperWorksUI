...
function addToCart(obj){
	...
	$("#cartTable").append('<tr><td>'+(++$("#cartTable > tr").length)+'</td><td><img src="images/'+$(obj).attr('data-id')+'.jpg" alt="Food" style="height:80px"></td><td>'+productMap[$(obj).attr('data-id')].split("#")[0]+'</td><td><input type="number" size="2" class="qty" style="width:55px" value="1"></td><td>Rs '+$(obj).attr('data-val')+'</td><td><input type="button" onClick="return removeCart(this)" value="Remove"></td></tr>');
	checkCartStatus();
}

function displayModalDetails(obj){	
	$("#modalLabel").html(productMap[$(obj).attr('data-id')].split("#")[0] + " Details");
	var str = '<div class="row"><div class="col-md-5" id="modal-img"><img src="images/'+$(obj).attr('data-id')+'.jpg" height="200px" width="200px" /></div><div class="col-md-7" id="modal-content">'+productMap[$(obj).attr('data-id')].split("#")[3]+'</div></div>';
